...
##Reading the image.
##Checking yhe pixal sof the image
##Resizeing the image 
...
edge_detection = cv2.Canny(grey_scaleing, 150,200)
mask = np.zeros_like(edge_detection)

polygon = np.array([[(0,h),(0,2000),(2050,1479),(4085,1947),(w,h)]], np.int32)
...
for x1,y1,x2,y2 in right_lines:
    cv2.line(image_resize, (x1,y1),(x2,y2),(255,0,0),5)
